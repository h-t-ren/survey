                ...
                <div id="navmenu">
                    <ul id="nav">
                       <li><a <c:if test="${sitemap=='main'}" >class="headerDisabledLink"</c:if> <c:if test="${sitemap!='main'}" >class="headerActiveLink"</c:if>  href="<c:url value="/" />">系统介绍</a></li>
                        ...
                        <li><a <c:if test="${sitemap=='question'}" >class="headerDisabledLink"</c:if> <c:if test="${sitemap!='question'}" >class="headerActiveLink"</c:if>  href="<c:url value="/question" />">答卷统计</a></li>
